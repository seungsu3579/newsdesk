...
def get_header(news_id):
    ...
    sql = "SELECT ne.news_id, nm.article_headline, ne.keyword, ne.key_sentence FROM (SELECT news_id, keyword, keysentence FROM news_extracted WHERE news_id = %s) AS ne\
